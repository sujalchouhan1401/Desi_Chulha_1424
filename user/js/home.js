            ...
            html += `
                <div class="modal-footer" style="margin-top: 20px; border-top: 2px solid var(--border-color); padding-top: 15px;">
                    ...
                    <div style="display: flex; gap: 10px; margin-top: 20px;">
                        <button class="btn-outline" style="flex: 1; border-color: var(--text-muted); color: var(--text-muted); padding: 12px; border-radius: 12px; cursor: pointer;" onclick="clearCartHandler()">Clear Cart</button>
