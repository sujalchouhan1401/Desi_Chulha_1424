...
const menuStorage = {
    ...
    DEFAULTS: [
        ...
        { id: "old_seed_25", name: "Samosa Chaat", category: "Chaat", price: 60, available: true, bestseller: false, isVeg: true, image: "../images/menu/samosa-chaat.png" },
        { id: "old_seed_26", name: "Fruit Salad", category: "Chaat", price: 120, available: true, bestseller: false, isVeg: true, image: "../images/menu/fruit-salad.jpg" },
        { id: "old_seed_26b", name: "Fruit Salad Chaat", category: "Chaat", price: 130, available: true, bestseller: false, isVeg: true, image: "../images/menu/fruit-salad-chaat.png" },

        // Indian Street Delights
        { id: "old_seed_14", name: "Puri Bhaji", category: "Indian Street Delight", price: 60, available: true, bestseller: false, isVeg: true, image: "../images/menu/puri-bhaji.png" },
        { id: "old_seed_15", name: "Poha", category: "Indian Street Delight", price: 40, available: true, bestseller: false, isVeg: true, image: "../images/menu/poha.jpg" },
        { id: "old_seed_16", name: "Bhel Puri", category: "Indian Street Delight", price: 50, available: true, bestseller: false, isVeg: true, image: "../images/menu/bhel-puri.jpg" },
        { id: "old_seed_17", name: "Pav Bhaji", category: "Indian Street Delight", price: 70, available: true, bestseller: true, isVeg: true, image: "../images/menu/pav-bhaji.png" },
        { id: "old_seed_18", name: "Vada Pav", category: "Indian Street Delight", price: 50, available: true, bestseller: true, isVeg: true, image: "../images/menu/vada-pav.png" },
        { id: "old_seed_19", name: "Dabeli", category: "Indian Street Delight", price: 30, available: true, bestseller: false, isVeg: true, image: "../images/menu/dabeli.jpg" },
        { id: "old_seed_20", name: "Veg Pakoda", category: "Indian Street Delight", price: 60, available: true, bestseller: false, isVeg: true, image: "../images/menu/veg-pakoda.jpg" },
        { id: "old_seed_21", name: "Cheela Besan", category: "Indian Street Delight", price: 40, available: true, bestseller: false, isVeg: true, image: "../images/menu/cheela-besan.jpg" },
        { id: "old_seed_22", name: "Cheela Suji", category: "Indian Street Delight", price: 40, available: true, bestseller: false, isVeg: true, image: "../images/menu/cheela-suji.png" },
        { id: "old_seed_23", name: "Popcorn", category: "Indian Street Delight", price: 50, available: true, bestseller: false, isVeg: true, image: "../images/menu/popcorn.jpg" },
        { id: "old_seed_24", name: "Chole Bhature", category: "Indian Street Delight", price: 70, available: true, bestseller: true, isVeg: true, image: "../images/menu/chole-bhature.jpg" },
        { id: "old_seed_25b", name: "Burger", category: "Indian Street Delight", price: 80, available: true, bestseller: false, isVeg: true, image: "../images/menu/burger.png" },
        { id: "old_seed_25c", name: "Pizza", category: "Indian Street Delight", price: 99, available: true, bestseller: false, isVeg: true, image: "../images/menu/pizza.png" },
        ...
        { id: "old_seed_44b", name: "Veg. Sandwich", category: "Bread", price: 50, available: true, bestseller: false, isVeg: true, image: "../images/menu/veg-sandwich.png" },
        { id: "old_seed_44c", name: "Veg Cheese Sandwich", category: "Bread", price: 60, available: true, bestseller: true, isVeg: true, image: "../images/menu/veg-cheese-sandwich.png" },
        ...
        { id: "old_seed_47b", name: "Chowmein", category: "Quick Bites", price: 60, available: true, bestseller: true, isVeg: true, image: "../images/menu/chowmein.png" },
    ...
    seedData: function (initialData) {
        ...
        const CURRENT_VERSION = 'v7'; // Bump this whenever data changes
